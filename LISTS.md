...
instantiate a QEWD-JSDB *Document Node Object* for a Document (ie a LMDB "Global") named *jsdbList*,
...
At this point, if you look in your LMDB database using the *global_list* script, you won't see a Global named *^jsdbList* yet, eg:
...
Now check in your LMDB database using the *global_list* script to see what's in the *jsdbList* Global, eg:
...
and if you check again in your LMDB database using the *global_list* script, you'll see the effect in terms of the *^jsdbList* Global:
...
Check in LMDB using the *global_list* script to see how they get physically stored, and compare this with what you see
...
look in LMDB using the *global_list* script to see what's happened to the *jsdbList* Global.
...
implement a queue.  And of course, because they are implemented as *Globals* within LMDB, the *List* or
